...
class TestMCStateless(unittest.TestCase):
    ...
    def test_use_case_1(self):
        ...
        prob = str(UBSMarkovChain.s_prob_of_sequence(mc.training_model, TestMCStateless.unknown_seq, log_prob=True))
    ...
    def test_use_case_2(self):
        ...
        '''
        mc = UBSMarkovChain(
            model=getDictFromJsonGZ(TestMCStateless.model_file)
        )
        prob = str(UBSMarkovChain.s_prob_of_sequence(mc.training_model, TestMCStateless.unknown_seq, log_prob=True))
        self.assertTrue( prob.startswith('-24.1470') , f"Unexpected prob: {prob}, instead of -24.1470..." )
    ...
    def test_use_case_3(self):
        ...
        UBSMarkovChain.s_prob_of_sequence(mc.training_model, TestMCStateless.unknown_seq, log_prob=True)
        prob = str(UBSMarkovChain.s_prob_of_sequence(mc.training_model, TestMCStateless.unknown_seq+'X', log_prob=True))
        self.assertTrue( prob.startswith('-28.8323'), f"Unexpected prob: {prob}, instead of -28.8323..." )
