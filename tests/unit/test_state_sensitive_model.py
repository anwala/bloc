...
class TestMCState(unittest.TestCase):
    ...
    def test_use_case_2(self):
        ...
        """
        mc = UBSMarkovChain(model=getDictFromJsonGZ(TestMCState.model_file))
        prob = str(mc.prob_of_sequence(TestMCState.unknown_seq, log_prob=True))
        self.assertTrue(
            prob.startswith("-24.1470"),
            f"Unexpected prob: {prob}, instead of -24.1470...",
    ...
    def test_use_case_3(self):
        ...
        self.assertTrue(
            prob.startswith("-30.4347"),
            f"Unexpected prob: {prob}, instead of -30.4347...",
        )
        ...
        prob = str(mc.prob_of_sequence(TestMCState.unknown_seq, log_prob=True))
        self.assertTrue(
            prob.startswith("-26.5845"),
            f"Unexpected prob: {prob}, instead of -26.5845...",
        )
